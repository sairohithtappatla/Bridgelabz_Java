...
public class LowerCaseComparison {
    ...
    public static String convertToLowerCase(String text) {
        ...
        for (int i = 0; i < text.length(); i++) {
            ...
            if (character >= 'A' && character <= 'Z') {
                ...
                // Convert uppercase character to lowercase using ASCII difference
    ...
    public static void main(String[] args) {
        ...
        // Convert text using the built-in toLowerCase() method
        ...
        System.out.println(
                "Lowercase using charAt(): " + userDefinedResult
        );

        // Display the built-in result
        System.out.println(
                "Lowercase using toLowerCase(): " + builtInResult
        );
